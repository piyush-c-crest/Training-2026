-- ARRAYS
-- reange_type(lower_bound, upper_bound)
-- range_type : INT4RANGE, INT8RANGE, NUMRANGE, TSRANGE, TSTZRANGE, DATARANGE

-- [ close rage,
-- ( open range

select
	INT4RANGE(1,6),  -- default [) closed , open
	NUMRANGE(1.23, 4.44, '[]')


select
	ARRAY[1,2,3],
	ARRAY[CURRENT_DATE, CURRENT_DATE+10]
